...
*Derived from: `docs/research/deep-research-ui-ux.md`, `docs/research/deep-research-ai-native.md`, `docs/ai/ai-competitive-landscape.md`, `docs/ai/ai-feature-brainstorm.md`, and competitive research across 15+ ABA platforms.*
