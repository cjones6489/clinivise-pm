...
Help BCBAs _write_ authorization requests (the other side of auth parsing). AI drafts clinical justification using session data and treatment progress.
...
_Add new ideas above the parking lot. Re-score quarterly as data availability and platform maturity change._
